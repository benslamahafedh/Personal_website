...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="logo" href="#">Hafedh Ben Slama</a>         
            <ul class="nav">
                <li class="item">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Hafedh </span>
            </h1>
            <p class="header-subtitle">Software Engineer</p>            
            <a href="#about"><button  class="btn btn-primary"> About Me </button></a>
        ...
        <div class="container text-center">
            ...
            <div class="about">
                <div class="about-img-holder">
                    <img src="assets/imgs/AvatarMaker-removebg-preview.png" class="about-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
                <div class="about-caption">
                    ...
                    <a href="https://flowcv.com/resume/skdsll853g"><button class="btn-rounded btn btn-outline-primary mt-4">View CV</button></a>
                </div>              
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <h6 class="title">Fullstack web dev</h6>
                            <p class="subtitle">I widevelop your custom website with cutting edge technologies and .</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="service-card">
                        <div class="body">
                            ...
                            <p class="subtitle">I will scrape anysite in order to automate and optimize your workflow.</p>
                        </div>
                    </div>
                </div>
            </div><!-- end of row -->
        ...
        <div class="container text-center text-sm-left">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm offset-sm-2 offset-md-3">
                    <a href="https://www.upwork.com/freelancers/~01c5bae5ce274df720" ><button class="btn btn-lg my-font btn-light rounded">Hire Me</button></a>
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Hafedh is an expert in web-scraping and data collection. He did not only completed the job in time but also delivered an excellent quality work. Look forward to work with you again.</p>
                            <h6 class="testimonial-card-title">Moradiaya</h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Finished the job super fast and explained everything super thoroughly.
                                Very professional and knows what he's doing.</p>
                            <h6 class="testimonial-card-title">Ilan</h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <footer class="footer">       
            ...
            <div class="social-links text-right m-auto ml-sm-auto">
                <a href="https://www.facebook.com/profile.php?id=100005555116957" class="link"><i class="ti-facebook"></i></a>
                <a href="https://twitter.com/SlamaHafedh" class="link"><i class="ti-twitter-alt"></i></a>
                <a href="https://www.linkedin.com/in/benslamahafedh/" class="link"><i class="ti-linkedin"></i></a>
            </div>
        </footer>
